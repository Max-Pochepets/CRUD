...
public class App {
    ...
    private static final Driver DRIVER_ED = new Driver("Ed", "123qwe222113");
    private static final Driver DRIVER_JOHN = new Driver("John", "AAAEWWW222JHDSF8899");
    private static final Driver DRIVER_BOB = new Driver("BOB", "IEH709898SDF7689SDF231");
    ...
    public static void main(String[] args) {
        ...
        carService.removeDriverFromCar(DRIVER_JOHN, CAR);
        System.out.println(carService.get(1L));
        ...
        DRIVER_ED.setName("Kent");
        MANUFACTURER.setName("Ford");
        driverService.update(DRIVER_ED);
